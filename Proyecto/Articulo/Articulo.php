<?php
    ...
    $sql="SELECT articulo.*, detalle_donacion.DESCRIPCION FROM articulo
    LEFT JOIN detalle_donacion ON articulo.ID_ARTICULO = detalle_donacion.ID_ARTICULO_FK";
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><?php echo $row['ESTADO_CALIDAD'] ?></td>
                  <td><?php echo $row['DESCRIPCION'] ?></td>
                  <td><a href="Editarart.php?id=<?php echo $row['ID_ARTICULO'] ?>" <i  class='bx bxs-paint button-delete'></i></a></td>
