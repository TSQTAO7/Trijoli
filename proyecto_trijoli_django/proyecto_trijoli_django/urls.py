...
urlpatterns = [
    ...
    path('reset_password/', auth_views.PasswordResetConfirmView.as_view(template_name="password-reset.html"), name='password_reset'),
    path('reset_password_send/', auth_views.PasswordResetDoneView.as_view(), name='password_reset_done'),
    path('reset/<uidb64>/<token>', auth_views.PasswordResetConfirmView.as_view(template_name="recuperar/password-confirm.html"), name='password_reset_confirm'),
